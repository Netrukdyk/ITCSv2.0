...
public class Blue extends Fragment implements OnClickListener {

	Button Button_switches;
	
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.blue, container, false);
        root.setBackgroundColor(Color.argb(50, 42, 42, 255));
